...
namespace WebProgramlamaProje.Models
{
    public class SalonDbContext : DbContext
    {
        ...
        public DbSet<IslemUzmanlik> IslemUzmanliklar { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // IslemUzmanlik
            modelBuilder.Entity<IslemUzmanlik>()
                .HasKey(iu => new { iu.IslemId, iu.UzmanlikId });

            modelBuilder.Entity<IslemUzmanlik>()
                .HasOne(iu => iu.Islem)
                .WithMany(i => i.IslemUzmanliklar)
                .HasForeignKey(iu => iu.IslemId);

            modelBuilder.Entity<IslemUzmanlik>()
                .HasOne(iu => iu.Uzmanlik)
                .WithMany(u => u.IslemUzmanliklar)
                .HasForeignKey(iu => iu.UzmanlikId);
        }
    }
}
